...
const CreateOrder = () => {
  ...
  const handleCorderproceed = () => {
    let shirtQuantity = CheckNullValue(count1.sc);
    let tshirtQuantity = CheckNullValue(count2.sc);
    let trousersQuantity = CheckNullValue(count3.sc);
    let jeansQuantity= CheckNullValue(count4.sc);
    let boxersQuantity = CheckNullValue(count5.sc);
    let joggersQuantity = CheckNullValue(count6.sc);
    let othersQuantity = CheckNullValue(count7.sc);
